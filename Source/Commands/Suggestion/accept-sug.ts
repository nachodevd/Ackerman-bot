...
export const command: Command = {
    name: "accept-sug",
    aliases: ['aceptar-sugerencia', 'accept-sug'],
    description: "Con este comando podras aceptar sugerencias",
    example: ['accept-sug 884547878670979072'],
    use: ['accept-sug <id> [razon]'],
    ...
    run: async (client, message, args) => {
        ...
        client.channels.fetch('911464171600769065').then((e) => {
          ...
          `);
            ...
            msg.edit(msg.embeds.map(e => e.setDescription('**Estado:**\nAceptada' + razon).setColor('GREEN'))).then(() => {
                message.lineReply(`${client.Emojis.check} Se acepto la sugerencia.`)
